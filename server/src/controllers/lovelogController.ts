...
export default class LoveLogController {
    static getLoveLogTemplate = async (req: Request, res: Response, next: NextFunction) => {
        try {
    ...
    static getLoveLog = async (req: Request, res: Response, next: NextFunction) => {
        try {
    ...
    static createLoveLog = async (req: Request, res: Response, next: NextFunction) => {
        try {
